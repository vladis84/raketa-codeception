<?php  //[STAMP] 36944bdc7b3849081a712ca8268e0267
...
trait RailTesterActions
{
     ...
     *
     * @param type $clientId
     * @see \Helper\Base::chooseClient()
     */
    public function chooseClient($clientId = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('chooseClient', func_get_args()));
    }
